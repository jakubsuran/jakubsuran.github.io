...
IF (Test-Path "HKCU:\Software\Microsoft\Office\14.0") {
	...
	New-ItemProperty "HKCU:\Software\Microsoft\Office\14.0\Outlook\Options\Mail" -Name "Send Pictures With Document" -Value 1 -PropertyType DWORD -Force
}
...
IF (Test-Path "HKCU:\Software\Microsoft\Office\15.0") {
	...
	New-ItemProperty "HKCU:\Software\Microsoft\Office\15.0\Outlook\Options\Mail" -Name "Send Pictures With Document" -Value 1 -PropertyType DWORD -Force
}
...
IF (Test-Path "HKCU:\Software\Microsoft\Office\16.0") {
	...
	New-ItemProperty "HKCU:\Software\Microsoft\Office\16.0\Outlook\Options\Mail" -Name "Send Pictures With Document" -Value 1 -PropertyType DWORD -Force
}
